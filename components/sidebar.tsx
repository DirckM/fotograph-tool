...
const libraryNavItems = [
  { href: "/dashboard/moodboard", label: "Moodboard", icon: LayoutGrid },
];
...
const bottomItems = [
  { href: "/dashboard/test", label: "Test Suite", icon: FlaskConical },
  ...
  return (
    <aside className="flex h-screen w-60 flex-col border-r border-border bg-sidebar">
      ...
      <nav className="flex flex-1 flex-col gap-1 overflow-y-auto p-2">
        ...
        <div data-tour="sidebar-moodboard">
        <p className="px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground/60">
          Library
        </p>
